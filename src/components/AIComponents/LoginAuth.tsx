...
const Auth: React.FC = () => {
  ...
  return (
    // Outer container to mimic the page background of the Hero section, if used standalone
    // If this component is placed within another layout already defining the background,
    // you might remove 'min-h-screen bg-gradient-to-br from-white via-brand-purple-light/5 to-brand-blue-light/10'
